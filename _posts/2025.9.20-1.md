...
### 普通图片（带尺寸）
![示例图片](/assets/img/sample.jpg){: w="800" h="450" }
_图1：基础图片展示（800x450像素）_

### 模式适配图片
![亮色模式专用图](/assets/img/light-mode.png){: .light }
![暗色模式专用图](/assets/img/dark-mode.png){: .dark }

### 带阴影效果的图片
![带阴影的截图](/assets/img/sample.jpg){: .shadow w="600" }
...
{% include embed/video.html
  ...
  poster='/assets/img/demo-cover.png'
  title='本地视频演示'
  loop=true
  muted=true
%}
